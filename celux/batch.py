...
class BatchMixin:
    ...
    def get_batch(self, indices: Union[List[int], range, slice, torch.Tensor, np.ndarray]) -> torch.Tensor:
        """
    ...
    def get_batch_range(self, start: int = 0, end: int = None, step: int = 1) -> torch.Tensor:
        """
